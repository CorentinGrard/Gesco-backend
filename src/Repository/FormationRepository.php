...
class FormationRepository extends ServiceEntityRepository
{
    ...
    public function UpdateFormation(FormationRepository $formationRepository, EntityManagerInterface $entityManager ,int $idFormation, Request $request, ResponsableRepository $personneRepository){

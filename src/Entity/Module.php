...
class Module
{
     ...
     * @Groups({"module_get", "matiere_get", "semestre_get", "get_notes_etudiant","delete_module","update_module"})
     */
    private $id;
     ...
     * @Groups({"module_get", "get_notes_etudiant","delete_module","update_module"})
     */
    private $ects;
